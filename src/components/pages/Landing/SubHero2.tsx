...
function SubHero2({ mainImage, title, description }: SubHeroProps) {
  return (
    <main
      ...
      <div className="md:w-[60%] xl:w-[40%] md:relative md:flex order-2 md:order-1 my-auto p-10 md:p-0">
        <div className="relative max-w-[400px] mx-auto ">
          ...
          <button
            className=" text-black tracking-[2px] flex font-semibold hover:underline hover:decoration-solid decoration-black"
            style={{ fontFamily: 'DM Sans, sans-serif' }}>
            VIEW THE STORIES
            <ArrowIcon
              color="black"
